...
// // CODE HERE 
// const first = (array, callbackName) => callbackName(array[0])
...
//const contains = (arr, name, callbackName) => callbackName(arr.includes(name))
...
// CODE HERE
//niq(names, uniqArr => console.log(`The new names array with all the duplicate items removed is ${uniqArr}`))
...
// */
// // const newCB = (element, index) =>{
// //   return `The item at index ${index} is ${element}.`
// // }
// console.log(each(names, (element, index) => `asdf ${element} asdf ${index}`))
// //each(names, newCB)
